...
The model/Adam/scheduler/RNG audit and fresh-candidate cost check are now complete. The endpoint decoding timing also passed; selection_execution_estimate_20260914.md combines all measurements with explicit evaluation-inventory scenarios. Nine runs starting from a trained common parent need a real restore cost in addition to this from-pretrained baseline. No full matrix has launched.

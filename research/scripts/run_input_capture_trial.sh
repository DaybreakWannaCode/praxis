...
export PRAXIS_CANDIDATE_COST_DIR=/workspace/praxis/runs/candidate-input-capture-20260915-001
export PRAXIS_CANDIDATE_INPUT_DIR="$PRAXIS_CANDIDATE_COST_DIR/inputs"
export PRAXIS_CANDIDATE_EXPORT_ROOT=/tmp/praxis-input-capture-20260915-001
export PRAXIS_CANDIDATE_EXPORT_MAX_BYTES=12000000000
export PRAXIS_PARENT_RECEIPT_SHA256="$(python - <<'PY'
import hashlib,json,pathlib,shutil,subprocess
p=pathlib.Path('/workspace/praxis/data/candidate-input-capture-20260915/plan.json')
...
cp /workspace/praxis/data/candidate-input-capture-20260915/config.yaml "$PRAXIS_CANDIDATE_COST_DIR/config.yaml"
cp /workspace/praxis/data/candidate-input-capture-20260915/plan.json "$PRAXIS_CANDIDATE_COST_DIR/plan.json"
cp /workspace/praxis/data/candidate-input-capture-20260915/preflight.json "$PRAXIS_CANDIDATE_COST_DIR/preflight.json"

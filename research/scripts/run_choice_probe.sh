...
run_dir=/workspace/praxis/runs/choice-probe-dev-20260914-001
mkdir "$run_dir"
cp /workspace/praxis/research/choice_probe_development_lock.md "$run_dir/"
set +e
/usr/bin/time -v timeout --signal=TERM --kill-after=60s 2h python -m transfer_alignment.choice_measure \
